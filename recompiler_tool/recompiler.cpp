...
void translate_instruction_block(std::ofstream& out_file, cs_insn* insn) {
    ...
    switch (insn->id) {
        ...
        case MIPS_INS_JR: {
            ...
            outFile << "    host_dispatch_jump(context.cpuRegs.GPR.r[" << target_reg_index << "].UD[0]);" << std::endl;
        ...
        case MIPS_INS_BEQ: {
            ...
            outFile << "        func_" << std::hex << target << "();" << std::endl
            outFile << "        return;" << std::endl;
            outFile << "    }" << std::endl;
            break;
        }
        case MIPS_INS_BNE: {
            ...
            outFile << "    if (context.cpuRegs.GPR.r[" << rs_index << "].UD[0] != context.cpuRegs.GPR.r[" << rt_index << "].UD[0]) {" << std::endl;
            outFile << "        func_" << std::hex << target_address << "();" << std::endl
            outFile << "        return;" << std::endl;
            outFile << "    }" << std::endl;
            break;
        }
        ...
        case MIPS_INS_BGTZ : {
            ...
            outFile << "        func_0x" << std::hex << target << "();" << std::endl;
            outFile << "        return;" << std::endl;
            outFile << "    }" << std::endl;
            break;
        }
        ...
        case MIPS_INS_JAL : {
            ...
            u32 target = calculate_target(insn);
            outFile << "    context.cpuRegs.GPR.r[31].UD[0] = " << insn->address << "+ 8;" << std::endl;
        ...
        case MIPS_INS_JALR : {
            ...
            */
            ...
            outFile << "    context.cpuRegs.GPR.r[ "<< rd_index <<" ].UD[0] = " << std::hex << insn->address <<  + 8 << ";" << std::endl;
            outFile << "    host_dispatch_jump(context.cpuRegs.GPR.r[ "<< rs_index <<" ].UD[0]);" << std::endl;
            outFile << "    return;" << std::endl;
            break;
        }
        case MIPS_INS_SYSCALL : {
            ...
            */
            ...
            outFile << "context.cpuRegs.CP0.n.EPC = " << insn->address <<" + 4;" << std::endl;
        ...
        */
        ...
        case MIPS_INS_BLTZL: {
            ...
            */
            ...
            outFile << "    context.cpuRegs.pc = " << insn->address << " + 4 + (" << offset << " << 2);" << std::endl;
            outFile << "} else {" << std::endl;
            outFile << "    context.cpuRegs.pc = " << insn->address << " + 8;" << std::endl;
            outFile << "}" << std::endl;
            return 2;
        }
        case MIPS_INS_BGEZL: {
        ...
        case MIPS_INS_BLTZAL: {
            ...
            int rs_index = get_gpr_index(rs_reg);
            outFile << "context.cpuRegs.GPR.r[31] = "<< insn->address <<" + 8;" << std::endl;
            if (i + 1 < total_count) {
                translate_instruction_block(outFile, insn, i + 1, total_count);
            }
        ...
        */
        ...
        default:
            outFile << "// Unhandled instruction: " << insn->mnemonic << std::endl;
            break;
    }
...
void translate_likely_instructions(std::ofstream& outFile, cs_insn* insn, cs_insn* delay_slot_insn){
    switch(insn->id){
        case MIPS_INS_BEQL: {
            // TODO: Implement BEQL (Branch on Equal Likely)
            // Branch likely instructions are tricky. For now, can treat as normal branch.
            ...
            */
            outFile << "    if ((s64)context.cpuRegs.GPR.r[" << rs_index << "].SD[0] == (s64)context.cpuRegs.GPR.r[" << rt_index << "].SD[0]) {" << std::endl;
            translate_instruction_block(outFile, delay_slot_insn);
            outFile << "        func_0x" << std::hex << target << "();" << std::endl;
            outFile << "        return;" << std::endl;
            outFile << "    }" << std::endl;
            break;
